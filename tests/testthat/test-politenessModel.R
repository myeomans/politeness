...
#
# context("politenessModel function")
#
# test_that("empty or na string", {
#  phone_offers$message[1] <- ""
#
#  v_recept <- politenessModel(c("","a"))
#  expect_equal(length(v_recept),2)
#
#  v_recept <- politenessModel(c(NA_character_,"a"))
#  expect_equal(length(v_recept),2)
#
#  phone_offers$message[1] <- NA_character_
#
#  v_recept <- politenessModel(phone_offers$message)
...
#   v_recept <- politenessModel(c(phone_offers$message[2],""))
#   expect_equal(length(v_recept),2)
# })
#
#
# test_that("text of length 1", {
#   v_recept <- politenessModel("hello")
