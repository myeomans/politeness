...
df_politeness_count <- politeness(phone_offers$message, binary=FALSE, num_mc_cores=1)
df_politeness_count[20:30,1:5]
```

```{r, echo=TRUE, eval=TRUE}
df_politeness <- politeness(phone_offers$message, binary=TRUE, num_mc_cores=1)
...
df_polite_train <- politeness(phone_offers$message, drop_blank=FALSE, num_mc_cores=1)

df_polite_holdout<-politeness(bowl_offers$message, drop_blank=FALSE, num_mc_cores=1)
